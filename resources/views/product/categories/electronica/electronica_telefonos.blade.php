    ...
    <div class="container position-relative">
        <form method="GET">
            <input type="text" class="form-control mx-auto" name="barra" placeholder="Buscar con filtros..."
                ...
                {!! $viewData['products_telefonos']->withQueryString()->links('layouts.pagination') !!}
...
@if (isset($viewData['products_telefonos']))
@foreach ($viewData['products_telefonos'] as $product)
    <div class="container ">
