    ...
    <div class="container position-relative">
        <form method="GET">
            <<input type="text" class="form-control mx-auto" name="barra" placeholder="Buscar con filtros..."
                ...
                {!! $viewData['products_monitores']->withQueryString()->links('layouts.pagination') !!}
...
@if (isset($viewData['products_monitores']))
@foreach ($viewData['products_monitores'] as $product)
    <div class="container ">
