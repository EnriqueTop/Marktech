    ...
    <div class="container position-relative">
        <form method="GET">
            <<input type="text" class="form-control mx-auto" name="barra" placeholder="Buscar con filtros..."
                ...
                {!! $viewData['products_alfombrillas']->withQueryString()->links('layouts.pagination') !!}
...
@if (isset($viewData['products_alfombrillas']))
@foreach ($viewData['products_alfombrillas'] as $product)
    <div class="container ">
