    ...
    <div class="container position-relative">
        <form method="GET">
            <<input type="text" class="form-control mx-auto" name="barra" placeholder="Buscar con filtros..."
                ...
                {!! $viewData['products_audifonos']->withQueryString()->links('layouts.pagination') !!}
...
@if (isset($viewData['products_audifonos']))
@foreach ($viewData['products_audifonos'] as $product)
    <div class="container ">
