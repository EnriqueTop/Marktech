    ...
    <div class="container position-relative">
        <form method="GET">
            <input type="text" class="form-control mx-auto" name="barra" placeholder="Buscar con filtros..."
                ...
                {!! $viewData['products_escritorio']->withQueryString()->links('layouts.pagination') !!}
...
@if (isset($viewData['products_escritorio']))
@foreach ($viewData['products_escritorio'] as $product)
    <div class="container ">
