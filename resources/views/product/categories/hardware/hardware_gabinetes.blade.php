    ...
    <div class="container position-relative">
        <form method="GET">
            <<input type="text" class="form-control mx-auto" name="barra" placeholder="Buscar con filtros..."
                ...
                {!! $viewData['products_gabinetes']->withQueryString()->links('layouts.pagination') !!}
...
@if (isset($viewData['products_gabinetes']))
@foreach ($viewData['products_gabinetes'] as $product)
    <div class="container ">
