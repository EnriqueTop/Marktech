    ...
    <div class="container position-relative">
        <form method="GET">
            <input type="text" class="form-control mx-auto" name="barra" placeholder="Buscar con filtros..."
                ...
                {!! $viewData['products_procesadores']->withQueryString()->links('layouts.pagination') !!}
...
@if (isset($viewData['products_procesadores']))
@foreach ($viewData['products_procesadores'] as $product)
    <div class="container ">
