    ...
    <div class="container position-relative">
        <form method="GET">
            <input type="text" class="form-control mx-auto" name="barra" placeholder="Buscar con filtros..."
                ...
                {!! $viewData['products_motherboard']->withQueryString()->links('layouts.pagination') !!}
...
@if (isset($viewData['products_motherboard']))
@foreach ($viewData['products_motherboard'] as $product)
    <div class="container ">
